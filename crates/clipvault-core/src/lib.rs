...
pub use peer_discovery::{
    ...
    DISCOVERY_ONLY_CAPABILITY, LIVENESS_CONFIRM_INTERVAL, MAX_PEER_DISPLAY_NAME_LENGTH,
    PROTOCOL_MAJOR, RUNTIME_INACTIVE_REASON_DISABLED, RUNTIME_INACTIVE_REASON_IDENTITY_UNAVAILABLE,
