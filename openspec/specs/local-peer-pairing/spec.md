...
Definir el vínculo mutuo entre pares locales detectados por mDNS: aprobación recíproca de un código SAS, identidad certificada fijada, transporte mTLS autenticado y ciclo de vida de confianza (Trusted / Revoked / Blocked) por par, sin exponer historial ni contenido.
