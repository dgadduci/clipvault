...
Definir cómo ClipVault permite a un par vinculado y activo navegar páginas recientes de previews acotados de capturas de texto transferibles desde el desktop principal, sobre transporte mTLS autenticado, sin descargar el contenido completo, sin crear entradas locales y sin exponer imágenes ni rich text.
