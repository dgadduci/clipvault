...
Definir la toolchain declarada, los comandos canónicos, el flujo Git/OpenSpec
entre macOS y Ubuntu, la cobertura CI no interactiva y las reglas de
higiene que permiten validar un mismo commit en ambas plataformas sin
borrar ni regenerar datos locales del usuario.
