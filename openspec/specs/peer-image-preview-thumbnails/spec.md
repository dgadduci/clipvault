# peer-image-preview-thumbnails Specification

## Purpose
Provide authenticated, on-demand previews of remote image captures using
bounded in-memory thumbnails, while keeping history pages metadata-only and
reserving transfer and persistence of the original image for explicit import.
