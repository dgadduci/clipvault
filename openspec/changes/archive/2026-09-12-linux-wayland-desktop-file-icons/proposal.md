...
## Decisión de cierre y trabajo diferido

Las tareas manuales restantes de este cambio se cierran explícitamente como
aceptación de alcance. La selección visual de aplicaciones para la blacklist
en Linux no está disponible todavía y la UI conserva el mensaje de fallback
que permite introducir identificadores manualmente.

El escenario de selección visual de blacklist se difiere al cambio
`linux-blacklist-app-picker`, que deberá definir una asociación segura entre
la aplicación seleccionada y el identificador que realmente publica el
adaptador activo de X11 o Wayland. Este cambio no implementa esa superficie ni
la considera un requisito pendiente para su archivo.
