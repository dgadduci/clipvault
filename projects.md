...
| Surface | Version |
| --- | --- |
| Cargo workspace (`Cargo.toml`) | 0.0.10 |
| Tauri config (`app/tauri/src-tauri/tauri.conf.json`) | 0.0.10 |
| Frontend package (`app/tauri/frontend/package.json`) | 0.0.10 |

The canonical public version is intentionally established at **0.0.10**.
...
patch is incremented to **0.0.10**.
