<script lang="ts">
   ...
   * source-app icon data, content hash, asset references). The
   * bounded source-app display name, when supported, arrives in
   * the browse row itself; no per-card presentation request runs.
   */
